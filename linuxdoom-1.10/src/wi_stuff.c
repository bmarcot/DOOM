...
boolean WI_Responder(event_t* UNUSED(ev))
{
    return false;
}
...
void WI_drawStats(void)
{
    ...
    V_DrawPatch(SP_TIMEX, SP_TIMEY, FB, time_ptch);
...
void WI_loadData(void)
{
    ...
    // "time"
    time_ptch = W_CacheLumpName("WITIME", PU_STATIC);
...
void WI_unloadData(void)
{
    ...
    Z_ChangeTag(time_ptch, PU_CACHE);
